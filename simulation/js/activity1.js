...
function activity1() {
    ...
    <div style='margin-top: 2vw;'>
        <br>
        <h4 class="center-text fs-20px fw-600">System of Linear Equations: Gaussian Jordan</h4>

        <div class="fs-16px">
        <h5>Pivoting</h5>
        <p>Learning Objective: To convert system of linear equations to diagonal matrix</p>
        </div>
